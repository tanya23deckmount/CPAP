...
class TitleBar(QWidget):
    def __init__(self, parent):
        ...
        # Title
        self.title = QLabel("CPAP Therapy Dashboard")
...
class SideBar(QWidget):
    def __init__(self, parent=None):
        ...
        company_name = QLabel("CPAP Therapy")
...
class DashboardPage(QWidget):
    def __init__(self, stacked_widget, user_data, show_form=None):
        ...
        # Welcome message
        self.welcome_label = QLabel("Welcome to CPAP Therapy Dashboard")
        ...
        self.content_frame_layout.setContentsMargins(20, 20, 20, 20)
        ...
        self.sidebar.user_btn.clicked.connect(self.show_view_user)
    ...
    def show_normal_dashboard(self):
        ...
        #     }
        # """)
        # users_card.setFixedHeight(100)
        # users_layout = QVBoxLayout(users_card)
        # users_title = QLabel("Total Users")
        # users_title.setStyleSheet("font-size: 14px;")
        # users_count = QLabel(str(total_users))
        # users_count.setStyleSheet("font-size: 24px; font-weight: bold;")
        # users_layout.addWidget(users_title)
        # users_layout.addWidget(users_count)
        
        # Add more stat cards as needed
        therapy_card = QFrame()
        therapy_card.setStyleSheet("""
            QFrame {
        ...
        """)
        therapy_card.setFixedHeight(100)
        therapy_layout = QVBoxLayout(therapy_card)
        therapy_title = QLabel("Therapy Sessions")
        therapy_title.setStyleSheet("font-size: 14px;")
        therapy_count = QLabel("0")
        therapy_count.setStyleSheet("font-size: 24px; font-weight: bold;")
        therapy_layout.addWidget(therapy_title)
        therapy_layout.addWidget(therapy_count)
        
        # Add cards to stats layout
        # stats_layout.addWidget(users_card)
        # stats_layout.addWidget(therapy_card)
        ...
        # Graph section
        graph_label = QLabel("CPAP Therapy Dashboard")
    ...
    def update_display(self):
        ...
        if isinstance(self.user_data, dict):
            self.user_details_added = self.user_data and any(self.user_data.values())
        elif isinstance(self.user_data, list):
            self.user_details_added = bool(self.user_data)
        else:
            self.user_details_added = False
            
        self.welcome_label.setText("Welcome to CPAP Therapy Dashboard")
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CPAP Therapy Dashboard")
